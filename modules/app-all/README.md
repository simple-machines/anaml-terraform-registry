...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_anaml-docs"></a> [anaml-docs](#module\_anaml-docs) | ../app-docs | n/a |
| <a name="module_anaml-server"></a> [anaml-server](#module\_anaml-server) | ../app-server | n/a |
| <a name="module_anaml-ui"></a> [anaml-ui](#module\_anaml-ui) | ../app-ui | n/a |
| <a name="module_ingress"></a> [ingress](#module\_ingress) | ../kubernetes-ingress | n/a |
| <a name="module_local-postgres"></a> [local-postgres](#module\_local-postgres) | ../postgres | n/a |
| <a name="module_spark-server"></a> [spark-server](#module\_spark-server) | ../app-spark-server | n/a |
...
|------|-------------|------|---------|:--------:|
| <a name="input_anaml_admin_email"></a> [anaml\_admin\_email](#input\_anaml\_admin\_email) | n/a | `string` | `null` | no |
| <a name="input_anaml_admin_password"></a> [anaml\_admin\_password](#input\_anaml\_admin\_password) | n/a | `string` | `null` | no |
...
| <a name="input_anaml_version"></a> [anaml\_version](#input\_anaml\_version) | Anaml version to deploy. This should be a valid Anaml container tag | `string` | n/a | yes |
| <a name="input_container_registry"></a> [container\_registry](#input\_container\_registry) | n/a | `string` | `"australia-southeast1-docker.pkg.dev/anaml-release-artifacts/docker"` | no |
| <a name="input_enable_form_client"></a> [enable\_form\_client](#input\_enable\_form\_client) | Enable Login form | `bool` | `false` | no |
| <a name="input_hostname"></a> [hostname](#input\_hostname) | The hostname Anaml will be accessed from. i.e 'dev.nonprod.anaml.app' | `string` | n/a | yes |
| <a name="input_https_urls"></a> [https\_urls](#input\_https\_urls) | n/a | `bool` | `true` | no |
| <a name="input_kubernetes_ingress_enable"></a> [kubernetes\_ingress\_enable](#input\_kubernetes\_ingress\_enable) | If true, deploy an ingress for Anaml | `bool` | `false` | no |
| <a name="input_kubernetes_ingress_hostname"></a> [kubernetes\_ingress\_hostname](#input\_kubernetes\_ingress\_hostname) | Optional hostname to use for the Anaml ingress definition when kubernetes\_ingress\_enable is true | `string` | `null` | no |
| <a name="input_kubernetes_ingress_name"></a> [kubernetes\_ingress\_name](#input\_kubernetes\_ingress\_name) | The name to use for the Anaml ingress definition | `string` | `"anaml"` | no |
| <a name="input_kubernetes_namespace_create"></a> [kubernetes\_namespace\_create](#input\_kubernetes\_namespace\_create) | If the given namespace should be created as part of this deployment | `bool` | `false` | no |
...
| <a name="input_kubernetes_persistent_volume_claim_storage_class_name_postgres"></a> [kubernetes\_persistent\_volume\_claim\_storage\_class\_name\_postgres](#input\_kubernetes\_persistent\_volume\_claim\_storage\_class\_name\_postgres) | n/a | `string` | `null` | no |
| <a name="input_kubernetes_pod_anaml_server_sidecars"></a> [kubernetes\_pod\_anaml\_server\_sidecars](#input\_kubernetes\_pod\_anaml\_server\_sidecars) | Optional sidecars to provision i.e. Google Cloud SQL Auth Proxy if deploying in GCP | <pre>set(<br>    object({<br>      name              = string,<br>      image             = string,<br>      image_pull_policy = optional(string), # Optional<br><br>      command = optional(list(string))<br><br>      env = optional(list(object({<br>        name  = string,<br>        value = string,<br>      })))<br><br>      env_from = optional(list(object({<br>        config_map_ref = object({ name = string })<br>        secret_ref     = object({ name = string })<br>      })))<br><br>      volume_mount = optional(list(object({<br>        name       = string,<br>        mount_path = string,<br>        read_only  = bool<br>      })))<br><br>      security_context = optional(object({<br>        run_as_non_root = optional(bool)<br>        run_as_group    = optional(number)<br>        run_as_user     = optional(number)<br>      }))<br><br>      port = optional(object({<br>        container_port = number<br>      }))<br>    })<br>  )</pre> | `[]` | no |
| <a name="input_kubernetes_pod_anaml_spark_server_sidecars"></a> [kubernetes\_pod\_anaml\_spark\_server\_sidecars](#input\_kubernetes\_pod\_anaml\_spark\_server\_sidecars) | Optional sidecars to provision i.e. Google Cloud SQL Auth Proxy if deploying in GCP | <pre>set(<br>    object({<br>      name              = string,<br>      image             = string,<br>      image_pull_policy = optional(string), # Optional<br><br>      command = optional(list(string))<br><br>      env = optional(list(object({<br>        name  = string,<br>        value = string,<br>      })))<br><br>      env_from = optional(list(object({<br>        config_map_ref = object({ name = string })<br>        secret_ref     = object({ name = string })<br>      })))<br><br>      volume_mount = optional(list(object({<br>        name       = string,<br>        mount_path = string,<br>        read_only  = bool<br>      })))<br><br>      security_context = optional(object({<br>        run_as_non_root = optional(bool)<br>        run_as_group    = optional(number)<br>        run_as_user     = optional(number)<br>      }))<br><br>      port = optional(object({<br>        container_port = number<br>      }))<br>    })<br>  )</pre> | `[]` | no |
| <a name="input_kubernetes_pod_node_selector_app"></a> [kubernetes\_pod\_node\_selector\_app](#input\_kubernetes\_pod\_node\_selector\_app) | Optional node\_selector config to apply to application services | `map(string)` | `null` | no |
| <a name="input_kubernetes_pod_node_selector_postgres"></a> [kubernetes\_pod\_node\_selector\_postgres](#input\_kubernetes\_pod\_node\_selector\_postgres) | If deploy\_postgres\_pod is true, optionally set the node\_selector for the postgres pod to target | `map(string)` | `null` | no |
| <a name="input_kubernetes_pod_node_selector_spark_executor"></a> [kubernetes\_pod\_node\_selector\_spark\_executor](#input\_kubernetes\_pod\_node\_selector\_spark\_executor) | Optional node\_selector config to apply to Apache Spark executors | `map(string)` | `null` | no |
| <a name="input_kubernetes_service_account_annotations"></a> [kubernetes\_service\_account\_annotations](#input\_kubernetes\_service\_account\_annotations) | n/a | `map(string)` | `{}` | no |
| <a name="input_kubernetes_service_account_create"></a> [kubernetes\_service\_account\_create](#input\_kubernetes\_service\_account\_create) | n/a | `bool` | `false` | no |
...
| <a name="input_kubernetes_service_annotations_anaml_docs"></a> [kubernetes\_service\_annotations\_anaml\_docs](#input\_kubernetes\_service\_annotations\_anaml\_docs) | Kubernetes service annotations to set if any for anaml-docs | `map(string)` | `null` | no |
| <a name="input_kubernetes_service_annotations_anaml_server"></a> [kubernetes\_service\_annotations\_anaml\_server](#input\_kubernetes\_service\_annotations\_anaml\_server) | Optional Kubernetes service annotations to set for anaml-server | `map(string)` | `null` | no |
...
| <a name="input_kubernetes_service_annotations_anaml_ui"></a> [kubernetes\_service\_annotations\_anaml\_ui](#input\_kubernetes\_service\_annotations\_anaml\_ui) | Optional Kubernetes service annotations to set for anaml-ui | `map(string)` | `null` | no |
| <a name="input_kubernetes_service_annotations_postgres"></a> [kubernetes\_service\_annotations\_postgres](#input\_kubernetes\_service\_annotations\_postgres) | Optional Kubernetes service annotations to set for Postgres | `map(string)` | `null` | no |
...
| <a name="input_kubernetes_service_enable_postgres"></a> [kubernetes\_service\_enable\_postgres](#input\_kubernetes\_service\_enable\_postgres) | If true, deploy a Postgres pod for Anaml to use. If false you should provide the Postgres host details | `bool` | `false` | no |
| <a name="input_kubernetes_service_type"></a> [kubernetes\_service\_type](#input\_kubernetes\_service\_type) | The Kubernetes service type to use. Valid values are ClusterIP, ExternalName, LoadBalancer or NodeIP | `string` | `"ClusterIP"` | no |
| <a name="input_oidc_additional_scopes"></a> [oidc\_additional\_scopes](#input\_oidc\_additional\_scopes) | OpenID Connect scopes to request from the provider. Optional when using OIDC authentication method. | `list(string)` | `[]` | no |
| <a name="input_oidc_client_id"></a> [oidc\_client\_id](#input\_oidc\_client\_id) | OpenID Connect client identifier. Required when using OIDC authentication method. | `string` | `null` | no |
| <a name="input_oidc_client_secret"></a> [oidc\_client\_secret](#input\_oidc\_client\_secret) | OpenID Connect client secret. Required when using OIDC authentication method. | `string` | `null` | no |
...
| <a name="input_oidc_tenant_id"></a> [oidc\_tenant\_id](#input\_oidc\_tenant\_id) | OpenID Connect tenant identifier. Required when using OIDC authentication method. | `string` | `null` | no |
| <a name="input_override_anaml_docs_version"></a> [override\_anaml\_docs\_version](#input\_override\_anaml\_docs\_version) | anaml-docs version override. This value should contain the container tag to deploy | `string` | `null` | no |
| <a name="input_override_anaml_server_anaml_database_schema_name"></a> [override\_anaml\_server\_anaml\_database\_schema\_name](#input\_override\_anaml\_server\_anaml\_database\_schema\_name) | n/a | `string` | `null` | no |
| <a name="input_override_anaml_server_version"></a> [override\_anaml\_server\_version](#input\_override\_anaml\_server\_version) | anaml-server version override. This value should contain the container tag to deploy | `string` | `null` | no |
| <a name="input_override_anaml_spark_server_additional_env_values"></a> [override\_anaml\_spark\_server\_additional\_env\_values](#input\_override\_anaml\_spark\_server\_additional\_env\_values) | n/a | <pre>list(object({<br>    name  = string<br>    value = string<br>  }))</pre> | `[]` | no |
| <a name="input_override_anaml_spark_server_additional_volume_mounts"></a> [override\_anaml\_spark\_server\_additional\_volume\_mounts](#input\_override\_anaml\_spark\_server\_additional\_volume\_mounts) | n/a | <pre>list(object({<br>    name       = string<br>    mount_path = string<br>    read_only  = bool<br>  }))</pre> | `[]` | no |
| <a name="input_override_anaml_spark_server_additional_volumes"></a> [override\_anaml\_spark\_server\_additional\_volumes](#input\_override\_anaml\_spark\_server\_additional\_volumes) | n/a | <pre>list(object({<br>    name = string<br><br>    secret = optional(object({<br>      secret_name = string<br>    }))<br><br>    config_map = optional(object({<br>      name = string<br>    }))<br>  }))</pre> | `[]` | no |
| <a name="input_override_anaml_spark_server_checkpoint_location"></a> [override\_anaml\_spark\_server\_checkpoint\_location](#input\_override\_anaml\_spark\_server\_checkpoint\_location) | n/a | `string` | n/a | yes |
| <a name="input_override_anaml_spark_server_spark_config_overrides"></a> [override\_anaml\_spark\_server\_spark\_config\_overrides](#input\_override\_anaml\_spark\_server\_spark\_config\_overrides) | n/a | `map(string)` | `{}` | no |
| <a name="input_override_anaml_spark_server_spark_log_directory"></a> [override\_anaml\_spark\_server\_spark\_log\_directory](#input\_override\_anaml\_spark\_server\_spark\_log\_directory) | n/a | `string` | n/a | yes |
| <a name="input_override_anaml_spark_server_version"></a> [override\_anaml\_spark\_server\_version](#input\_override\_anaml\_spark\_server\_version) | anaml-spark-server version override. This value should contain the container tag to deploy | `string` | `null` | no |
| <a name="input_override_anaml_ui_api_url"></a> [override\_anaml\_ui\_api\_url](#input\_override\_anaml\_ui\_api\_url) | anaml-ui api\_url override | `string` | `null` | no |
| <a name="input_override_anaml_ui_enable_new_functionality"></a> [override\_anaml\_ui\_enable\_new\_functionality](#input\_override\_anaml\_ui\_enable\_new\_functionality) | true\|false - whether to enable new functionality behind feature flags | `bool` | `false` | no |
| <a name="input_override_anaml_ui_skin"></a> [override\_anaml\_ui\_skin](#input\_override\_anaml\_ui\_skin) | anaml-ui skin override | `string` | `"anaml"` | no |
| <a name="input_override_anaml_ui_version"></a> [override\_anaml\_ui\_version](#input\_override\_anaml\_ui\_version) | anaml-ui version override. This value should contain the container tag to deploy | `string` | `null` | no |
| <a name="input_override_spark_history_server_additional_env_values"></a> [override\_spark\_history\_server\_additional\_env\_values](#input\_override\_spark\_history\_server\_additional\_env\_values) | n/a | <pre>list(object({<br>    name  = string<br>    value = string<br>  }))</pre> | `[]` | no |
| <a name="input_override_spark_history_server_additional_volume_mounts"></a> [override\_spark\_history\_server\_additional\_volume\_mounts](#input\_override\_spark\_history\_server\_additional\_volume\_mounts) | n/a | <pre>list(object({<br>    name       = string<br>    mount_path = string<br>    read_only  = bool<br>  }))</pre> | `[]` | no |
| <a name="input_override_spark_history_server_additional_volumes"></a> [override\_spark\_history\_server\_additional\_volumes](#input\_override\_spark\_history\_server\_additional\_volumes) | n/a | <pre>list(object({<br>    name = string<br><br>    secret = optional(object({<br>      secret_name = string<br>    }))<br><br>    config_map = optional(object({<br>      name = string<br>    }))<br>  }))</pre> | `[]` | no |
| <a name="input_postgres_host"></a> [postgres\_host](#input\_postgres\_host) | The postgres host to use if kubernetes\_service\_enable\_postgres if false and using an external postgres database | `string` | `null` | no |
| <a name="input_postgres_password"></a> [postgres\_password](#input\_postgres\_password) | The pstgress user password to connect to remote DB. If kubernetes\_service\_enable\_porstgres is true this value is used to set the local postgres password | `string` | `null` | no |
| <a name="input_postgres_port"></a> [postgres\_port](#input\_postgres\_port) | n/a | `number` | `5432` | no |
| <a name="input_postgres_user"></a> [postgres\_user](#input\_postgres\_user) | The postgres user to use if kubernetes\_service\_enable\_postgres if false and using an external postgres database | `string` | `"anaml"` | no |
...
| <a name="output_kubernetes_service_account"></a> [kubernetes\_service\_account](#output\_kubernetes\_service\_account) | The Kubernetes service account used for deployments |
<!-- END_TF_DOCS -->