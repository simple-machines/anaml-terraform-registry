...
module "spark-server" {
  ...
  additional_spark_executor_pod_tolerations = var.override_anaml_spark_server_additional_spark_executor_pod_tolerations
  additional_spark_driver_pod_tolerations   = var.override_anaml_spark_server_additional_spark_driver_pod_tolerations
