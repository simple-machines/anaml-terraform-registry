...
| <a name="input_insights_config_query_insights_enabled"></a> [insights\_config\_query\_insights\_enabled](#input\_insights\_config\_query\_insights\_enabled) | n/a | `bool` | `true` | no |
| <a name="input_insights_config_query_string_length"></a> [insights\_config\_query\_string\_length](#input\_insights\_config\_query\_string\_length) | n/a | `number` | `1024` | no |
| <a name="input_insights_config_record_application_tags"></a> [insights\_config\_record\_application\_tags](#input\_insights\_config\_record\_application\_tags) | n/a | `bool` | `false` | no |
| <a name="input_insights_config_record_client_address"></a> [insights\_config\_record\_client\_address](#input\_insights\_config\_record\_client\_address) | n/a | `bool` | `false` | no |
| <a name="input_ip_configuration_ipv4_enabled"></a> [ip\_configuration\_ipv4\_enabled](#input\_ip\_configuration\_ipv4\_enabled) | n/a | `bool` | `false` | no |
| <a name="input_ip_configuration_private_network_id"></a> [ip\_configuration\_private\_network\_id](#input\_ip\_configuration\_private\_network\_id) | n/a | `string` | n/a | yes |
| <a name="input_name_prefix"></a> [name\_prefix](#input\_name\_prefix) | n/a | `string` | `"anaml-"` | no |
| <a name="input_password"></a> [password](#input\_password) | n/a | `string` | n/a | yes |
| <a name="input_postgresql_deploy_versions"></a> [postgresql\_deploy\_versions](#input\_postgresql\_deploy\_versions) | Versions of PostgreSQL to deploy. Can facilitate with upgrades. | `list(any)` | <pre>[<br>  "13"<br>]</pre> | no |
| <a name="input_project_name"></a> [project\_name](#input\_project\_name) | GCP project name. | `string` | n/a | yes |
| <a name="input_region"></a> [region](#input\_region) | GCP region | `string` | n/a | yes |
| <a name="input_tier"></a> [tier](#input\_tier) | n/a | `string` | `"db-custom-2-8192"` | no |
| <a name="input_user"></a> [user](#input\_user) | n/a | `string` | `"anaml"` | no |
...
| <a name="output_ca_cert_common_name"></a> [ca\_cert\_common\_name](#output\_ca\_cert\_common\_name) | n/a |
| <a name="output_ca_cert_create_time"></a> [ca\_cert\_create\_time](#output\_ca\_cert\_create\_time) | n/a |
| <a name="output_ca_cert_expiration_time"></a> [ca\_cert\_expiration\_time](#output\_ca\_cert\_expiration\_time) | n/a |
| <a name="output_ca_cert_sha1_fingerprint"></a> [ca\_cert\_sha1\_fingerprint](#output\_ca\_cert\_sha1\_fingerprint) | n/a |
| <a name="output_connection_name"></a> [connection\_name](#output\_connection\_name) | n/a |
| <a name="output_first_ip_address"></a> [first\_ip\_address](#output\_first\_ip\_address) | n/a |
| <a name="output_ip_address"></a> [ip\_address](#output\_ip\_address) | n/a |
| <a name="output_ip_address_time_to_retire"></a> [ip\_address\_time\_to\_retire](#output\_ip\_address\_time\_to\_retire) | n/a |
| <a name="output_ip_address_type"></a> [ip\_address\_type](#output\_ip\_address\_type) | n/a |
| <a name="output_name"></a> [name](#output\_name) | n/a |
| <a name="output_pricate_ip_address"></a> [pricate\_ip\_address](#output\_pricate\_ip\_address) | n/a |
| <a name="output_public_ip_address"></a> [public\_ip\_address](#output\_public\_ip\_address) | n/a |
| <a name="output_self_link"></a> [self\_link](#output\_self\_link) | n/a |
| <a name="output_service_account_email_address"></a> [service\_account\_email\_address](#output\_service\_account\_email\_address) | n/a |
<!-- END_TF_DOCS -->